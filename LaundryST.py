...
def ask_openai(question, memory):
    try:
        messages = [
            {
                "role": "system",
        ...
        # Adiciona o histórico de memória à mensagem
...
# Inicializa o log de conversa e memória curta no session_state
...
def process_message(question):
    ...
    if question:
        ...
        # Adiciona o contexto da pergunta do usuário à memória curta
        st.session_state.memory.append({"role": "user", "content": question})

        answer = ask_openai(question, st.session_state.memory)

        # Adiciona a resposta do bot à memória curta
...
if submitted and user_input:
    ...
    # Força a reinicialização para limpar o campo de texto
